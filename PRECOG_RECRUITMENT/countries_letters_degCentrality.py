...
node_sizes = [1000 + 6000 * degree_centrality[node] for node in G.nodes()]

print(degree_centrality)

# Use a smooth color gradient (Plasma colormap)
color_map = cm.get_cmap('plasma', len(G.nodes()))
...
# Add title
plt.title("Letter-Based Country Graph (Degree Centrality-Based)", fontsize=20, fontweight="bold")
plt.axis("off")
plt.show()
